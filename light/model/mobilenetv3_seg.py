...
class _LRASPP(nn.Module):
    ...
    def __init__(self, in_channels, norm_layer, **kwargs):
        ...
        self.b1 = nn.Sequential(
            # INFO: mine
            # nn.AvgPool2d(kernel_size=(49, 49), stride=(16, 20)),  # This kernel is too large for input sizes below 784x784
            nn.AvgPool2d(kernel_size=(43, 43), stride=(16, 20)),  # This kernel allows input size of 700x700
            nn.Conv2d(in_channels, out_channels, 1, bias=False),
            nn.Sigmoid(),
        )
